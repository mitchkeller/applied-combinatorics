...
{
  "id": "notes-strings-2-8",
  "level": "2",
  "url": "notes-strings-2.html#notes-strings-2-8",
  "type": "Activity",
  "number": "2.3",
  "title": "",
...
},
{
  ...
  "body": " Binomial Theorem   Let and be real numbers so that , , and are all nonzero. For every nonnegative integer ,    "
},
{
  ...
  "number": "2.11",
  "title": "",
  "body": "  How many rearrangements of the string are there if all letters must be used?    Length of string is 48 characters.                        Letter  A  P  L  I  E  D  C  O  M  B  N  T  R  S  H  G  V  K    Count  2  2  1  6  6  1  2  5  2  2  3  5  3  4  1  1  1  1          "
},
{
  "id": "thm-multinomial",
  "level": "2",
...
},
{
  ...
  "number": "9.1",
  "title": "",
  "body": "  A linear recurrence equation is of the form where is an integer and is a function.  We call the terms the recursive terms and linear relates to not being able to multiply recursive terms. The functions are the coefficients .  If each is a contant with , then we say the equation has constant coefficients .    "
},
{
  "id": "def-homog-recurr",
  "level": "2",
  ...
  "number": "9.2",
  "title": "",
  "body": "  The linear recurrence equation is called homogeneous if for all .  Key here is to get all of the recursive terms on one the left-hand side and all non-recursive terms on the right-hand side. After doing that, the equation is homogeneous if and only if the right-hand side is .   "
},
{
...
},
{
  ...
  "body": " Solving a Nonlinear Recurrence    RUBOTS     Rooted  One special vertex, drawn at the top    Unlabeled  Vertices don't have names , unlike when we counted labeled trees.    Binary  Every vertex has 0 or 2 children    Ordered  Left child and right child so that the tree in which the left child of the root has two children and the right has none is different to the tree in which the left child of the root has no children and the right child has two.    Trees  Connected, acyclic graphs.     By convention, we want the -vertex graph to be a RUBOT with one leaf.  Let denote the number of RUBOTs with  leaves . ( NOT vertices!) Take by convention. The generating function for the number of RUBOTs is then     Find , , , and by drawing the RUBOTs with , , , and leaves and then start writing out .     The RUBOTs with at most four leaves                                                             , , ,      Decomposing RUBOTs    Let and be the left and right children, respectively, of the root of a RUBOT. How many RUBOTs with leaves have of those leaves descendants of and descendants of ?           Generalize to a formula for the number of RUBOTs with leaves in which the left child has leaves.           Give a nonlinear recurrence for .                  Use the quadratic formula to solve for . Use what you know about the constant term of to determine whether you want the plus or the minus from the in the quadratic formula.     We want a constant term of 0, which means that we need to choose the minus from the .    Recall that .   We need to get exactly . That then gives us a constant term of 0, so we take .    The generating function for the number of rooted, unlabeled, binary, ordered trees with leaves is        Ramsey Numbers    The Ramsey number  is the least number such that every graph on at least vertices contains a clique of size or an independent set of size .       What is a clique? What is an independent set?    A clique is a set of vertices, each pair of which are adjacent. An independent set is a set of vertices, no pair of which are adjacent.      Explain why .    As soon as you have two vertices, they must either have an edge between them or be non-adjacent. The first creates a 2-clique and the second creates an independent set of size 2.      Can you draw a -vertex graph that has neither a -clique nor an independent set of size ? What about vertices? vertices?    For four vertices, consider . For five vertices, consider . This is impossible for six vertices.       The Ramsey number .    Fix a vertex . The degree of is an integer between 0 and 5. We first consider the case where the degree of is at least 3. In this case, if any pair amongst the (at least) three neighbors of are adjacent, we have a formed by and a pair of its adjacent neighbors. Otherwise, there are no edges amongst these (at least) three neighbors of , and we have a 3-vertex (or larger) independent set. Now suppose that the degree of is at most 2. In this case, if any pair amongst the (at least) three non-neighbors of are not adjacent, then along with those two vertices forms a 3-vertex independent set. Otherwise, all of the non-neighbors of are adjacent and form a clique. Since has at least 3 non-neighbors in this case, we have a clique of size at least 3.    Paul Erdős on vs and Small Ramsey Numbers by S.P. Radziszowski    "
},
{
...
{
  "id": "notes-recurrence-rubots-3-5",
  "level": "2",
