#!/bin/bash
#
# Applied Combinatorics EPUB build script
#
# History
#
# 2019 June 19: copied from mathbook/examples/epub
#               Hash 9ed18b36c8e14d7d4691b9c1dd668b1ca99aa846
...
declare MJNODE=/Users/justice/node_modules/mathjax-node-page

# Working areas
# DEBUG saves post-xsltproc, pre-mathjax-node
# and also post-mathjax-node, pre-sed
declare SCRATCH=/Users/justice/Documents/github/applied-combinatorics/output
...
declare SRC=/Users/justice/Documents/github/applied-combinatorics/src
declare SRCMASTER=${SRC}/index.ptx
...
for f in ${EPUBOUT}/EPUB/xhtml/*.xhtml; do
    echo "Working on" $f
    mv $f $f.temp;
    ${MJNODE}/bin/mjpage --noGlobalSVG 1 < $f.temp > $f;
