...
},
{
  ...
  "number": "1.1.2",
  "title": "",
  "body": "  In Section 1.3 Combinatorics and Graph Theory, we endeavor to show how intuitive many of the ideas in combinatorics can be. We will define the terms of this section precisely in Chapter 5, so don't worry when we move on today without a careful understanding of things!     Discuss the 11 items after Figure 1.2. Which of these can you understand from the context given? What things remain unclear or unambiguous in a way that suggests we will want more precise definitions later on?      Discuss the five questions of Example 1.3. Are there any you can confidently answer today? What does your gut tell you about how easy or hard it would be for a computer algorithm to answer these questions efficiently?      For Example 1.5, spend a few minutes trying to answer the questions presented after Figure 1.6, which is reproduced below so you can draw on it if you'd like.    24 points, each labled with an integer from 1 through 6. There is a line segment below the points to indicate a scale distance of 200 miles.        Discuss Example 1.7 briefly. Does this seem to be a hard problem or an easy one?    "
},
{
  "id": "ws-day_one-5",
  "level": "2",
...
{
  "id": "ws-induction-recursive-count-3",
  "level": "2",
  "url": "ws-induction-recursive-count.html#ws-induction-recursive-count-3",
  "type": "Problem",
  "number": "3.1.2",
  "title": "",
...
{
  "id": "ws-induction-recursive-count-4",
  "level": "2",
  "url": "ws-induction-recursive-count.html#ws-induction-recursive-count-4",
  "type": "Problem",
  "number": "3.1.3",
  "title": "",
...
{
  "id": "ws-induction-recursive-count-5",
  "level": "2",
  "url": "ws-induction-recursive-count.html#ws-induction-recursive-count-5",
  "type": "Problem",
  "number": "3.1.4",
  "title": "",
...
},
{
  ...
  "number": "5.4",
  "title": "Planar or Not?",
  "body": " Planar or Not?       A graph with 6 vertices   A graph with vertices. The adjacencies are given below.    Vertex  Neighbors     , ,     , ,     , , ,     , , , ,     , , ,     , ,       graph={1:[3,4,5],2:[3,4,5],3:[4,6],4:[5,6],5:[6]}                    A graph with 10 vertices labeled 0 to 9. For the vertices with labels 0 through 4, the vertex with label has neighbors , , and . The first two adjacencies are interpreted cyclically so that, for instance, has neighbors and . For the vertices with labels 5 through 9, the vertex with label has neighbors , , and . The second and third adjacencies are interpreted cyclically so that, for instance, has neighbors and .     N=5  g(t)=(0.5*cos(2*pi*t\/N), 0.5*sin(2*pi*t\/N))  f(t)=(cos(2*pi*t\/N), sin(2*pi*t\/N))                         A graph with 8 vertices   A graph with vertices. The adjacencies are given below.    Vertex  Neighbors     , , ,     , ,     , ,     , , ,     , ,     , , ,     , , ,     , ,       graph={1:[2,3,5,6],2:[4,6],3:[4,7],4:[7,8],5:[6,7],6:[8],7:[8]}                     A graph with 8 vertices   A graph with vertices. The vertices are arranged at the vertices of a regular octagon. Each vertex has degree . The five neighbors are the two immediately adjacent (on on either side) around the octagon as well as the three opposite. For example, vertex has neighbors and (adjacent on the octagon) and (opposite on the octagon).     N=8  f(t)=(cos(2*pi*t\/N), sin(2*pi*t\/N))                     (Cube with diagonals of all six faces)   A graph with 8 vertices   A graph with vertices. The adjacencies are given below.    Vertex  Neighbors     , , , , ,     , , , , ,     , , , , ,     , , , , ,     , , , , ,     , , , , ,     , , , , ,     , , , , ,       graph={1:[2,3,4,5,6,7],2:[3,4,5,6,8],3:[4,5,7,8],4:[6,7,8],5:[6,7,8],6:[7,8],7:[8]}                   (cube with interior diagonals)   A graph with 8 vertices   A graph with 8 vertices. The adjacencies are given below.    Vertex  Neighbors     , , ,     , , ,     , , ,     , , ,     , , ,     , , ,     , , ,     , , ,       graph={1:[2,3,5,8],2:[4,6,7],3:[4,6,7],4:[5,8],5:[6,7],6:[8],7:[8]}                       The graph is not planar, as it contains a . In fact, this graph is plus two additional edges ( and .)     is not planar, but this is tougher to see. Refer to , where we illustrate a subdivision. The vertex , which is shown in magenta, is not required for the subdivision. The yellow vertices form one side of the while form the other. The dashed edges through the gray vertices ( ) are the disjoint paths that, when combined with the edges around the outside of the hexagon ( ) complete the subdivision.    The graph is planar, as shown in     The graph is not planar, as it has edges and vertices, but . Thus, it has too many edges to be planar.    The graph is not planar because it has edges and vertices, but . Thus, it has too many edges to be planar.    The graph is not planar because it contains . As one example of a , put in one set and in the other. We then have an edge from each vertex of the first set to each vertex of the second set.      A planar drawing of   A planar drawing   A planar drawing of the graph formed by adding the diagonals to two opposite faces of a cube.     graph={1:[2,3,5,6],2:[4,6],3:[4,7],4:[7,8],5:[6,7],6:[8],7:[8]}                   Demonstrating that the Petersen graph is nonplanar    A drawing of the Petersen graph that emphasizes the subdivision it contains. The text contains more details about this image.     N=6  M=3  g(t)=(0.55*cos(2*pi*t\/M+pi\/6), 0.55*sin(2*pi*t\/M+pi\/6))  f(t)=(cos(2*pi*t\/N), sin(2*pi*t\/N))                          "
},
{
...
{
  "id": "cube-plus-two-planar",
  "level": "2",
  "url": "ws-planar-or-not.html#cube-plus-two-planar",
  "type": "Figure",
  "number": "5.9",
  "title": "",
  "body": " A planar drawing of   A planar drawing   A planar drawing of the graph formed by adding the diagonals to two opposite faces of a cube.     graph={1:[2,3,5,6],2:[4,6],3:[4,7],4:[7,8],5:[6,7],6:[8],7:[8]}                 "
},
{
  "id": "petersen-nonplanar",
  "level": "2",
  "url": "ws-planar-or-not.html#petersen-nonplanar",
  "type": "Figure",
  "number": "5.10",
  "title": "",
  "body": " Demonstrating that the Petersen graph is nonplanar    A drawing of the Petersen graph that emphasizes the subdivision it contains. The text contains more details about this image.     N=6  M=3  g(t)=(0.55*cos(2*pi*t\/M+pi\/6), 0.55*sin(2*pi*t\/M+pi\/6))  f(t)=(cos(2*pi*t\/N), sin(2*pi*t\/N))                         "
},
{
  "id": "ws-prufer-codes",
  "level": "1",
...
},
{
  ...
  "type": "Worksheet",
  "number": "6.1",
  "title": "Posets and Graphs; Antichain Partitioning",
  "body": " Posets and Graphs; Antichain Partitioning      Classify each of the terms below as a poset term or a graph theory term. You will have six terms of each type.  Antichain  Chain  Chromatic number  Clique  Clique number  Height  Independent set  Partition into disjoint antichains  Partition into disjoint chains  Partition into disjoint cliques  Proper coloring  Width        Write the six poset terms from the previous part on separate rows in the Poset column of the table below. Place each of the six graph theory terms into both the Comparability Graph column and the Incomparability Graph column, choosing the row in which a term is placed so that the graph term for that type of graph corresponds to the poset term in that row. You will have one empty cell in each of the graph columns and one cell in each graph column will contain two graph theory terms!        Poset  Comparability Graph  Inomparability Graph                                                                                                                                    Use the algorithm to find the height , a partition into antichains, and a maximum chain for each of the posets below.      What can you say about the width of these posets? In particular, is one of the antichains in your antichain partition maximum?       The diagram of a poset with 10 points.                      The diagram of a poset with 25 points.                                      "
},
{
  "id": "ws-posets-antichain-partitioning-2-1",
  "level": "2",
  "url": "ws-posets-antichain-partitioning.html#ws-posets-antichain-partitioning-2-1",
  "type": "Activity",
  "number": "6.1.1",
  "title": "",
  "body": "   Classify each of the terms below as a poset term or a graph theory term. You will have six terms of each type.  Antichain  Chain  Chromatic number  Clique  Clique number  Height  Independent set  Partition into disjoint antichains  Partition into disjoint chains  Partition into disjoint cliques  Proper coloring  Width        Write the six poset terms from the previous part on separate rows in the Poset column of the table below. Place each of the six graph theory terms into both the Comparability Graph column and the Incomparability Graph column, choosing the row in which a term is placed so that the graph term for that type of graph corresponds to the poset term in that row. You will have one empty cell in each of the graph columns and one cell in each graph column will contain two graph theory terms!        Poset  Comparability Graph  Inomparability Graph                                                                                                                              "
},
{
  "id": "ws-posets-antichain-partitioning-3-1",
  "level": "2",
  "url": "ws-posets-antichain-partitioning.html#ws-posets-antichain-partitioning-3-1",
  "type": "Activity",
  "number": "6.1.2",
  "title": "",
  "body": "   Use the algorithm to find the height , a partition into antichains, and a maximum chain for each of the posets below.      What can you say about the width of these posets? In particular, is one of the antichains in your antichain partition maximum?    "
}
]
